...
void GL_Camera::RecalculateLookat() {
    ...
    rightDirection = glm::vec3(modelMatrix[0][0],modelMatrix[0][1],modelMatrix[0][2]);
    upDirection = glm::vec3(modelMatrix[1][0],modelMatrix[1][1],modelMatrix[1][2]);
    forwardDirection = glm::vec3(modelMatrix[2][0],modelMatrix[2][1],modelMatrix[2][2]);
}
